...
browserFingerprint.screen_width = customScreenWidth;
browserFingerprint.screen_height = customScreenHeight;
browserFingerprint.innerWidth = customInnerWidth;
browserFingerprint.innerHeight = customInnerHeight;
...
def generateBackgroudScript():
    print('Generating background-script.js')
    # create
    file_name = export_directory + '/background-script.js'
    f = open(file_name, "w")
    # contents
    contents = """
